...
wget -o "C:\Users\Public\Desktop\OPEN-BULLET LATEST VERSION.zip" https://raw.githubusercontent.com/rvg22/rvg/main/Files/OPEN-BULLET LATEST VERSION.zip > out.txt 2>&1
